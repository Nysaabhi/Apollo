...
const locatorsData = [
  {
    ...
    details: {
      name: "Fresh Mart",
      image: "https://www.entrepreneurhunt.com/wp-content/uploads/2022/06/G-Fresh-Mart-Franchise.png",
...
.action-button i {
  margin-right: 5px; /* Optional: To add some spacing between the icon and text */
}
